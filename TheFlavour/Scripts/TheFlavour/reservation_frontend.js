...
jQuery(document).ready(function () {
    ...
    jQuery('.tfuse_rf_post_datepicker_in, .tfuse_rf_post_datepicker_out').datetimepicker({
        timepicker: false,
        format: 'd.m.Y',
    ...
    $('.reservationForm').each(function () {
        ...
        $(this).ajaxForm({
            ...
            success: function (isSent, statusText, xhr) {
                if (isSent != 1) {
                    showErrorMessage("Something went wrong! Check required firlds please.");
                } else {
